...
var move_vec : Vector3 #keep track of our current vector
var velocity : Vector3 
var snap_vec : Vector3 #control how we snap to the ground
export var ignore_rotation = false #for player movement, AI uses global positions
